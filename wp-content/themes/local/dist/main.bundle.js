...
var CheckoutPaymentComponent = /** @class */ (function () {
    ...
    CheckoutPaymentComponent.prototype.constructVehicleObject = function () {
        var vehicleInfo = {
...
var CheckoutReviewComponent = /** @class */ (function () {
    function CheckoutReviewComponent(bagService, orderService, router, customerService, wpService, fb) {
        this.bagService = bagService;
        this.orderService = orderService;
        this.router = router;
        this.customerService = customerService;
