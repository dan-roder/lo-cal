...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__local_services_wp_service__ = __webpack_require__("./src/app/services/wp.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CheckoutReviewComponent = /** @class */ (function () {
    function CheckoutReviewComponent(bagService, constants, orderService, router, fb, customerService, wpService) {
        this.bagService = bagService;
        this.constants = constants;
        this.orderService = orderService;
        this.router = router;
    ...
    CheckoutReviewComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__local_services_bag_service__["a" /* BagService */],
            ...
            __WEBPACK_IMPORTED_MODULE_7__local_services_wp_service__["a" /* WordpressService */]])
