...
var MainLayoutComponent = /** @class */ (function () {
    function MainLayoutComponent(wpService, bagService, localStorage, router) {
...
var CheckoutReviewComponent = /** @class */ (function () {
    function CheckoutReviewComponent(bagService, orderService, router, fb, customerService, wpService) {
        this.bagService = bagService;
        this.orderService = orderService;
        this.router = router;
        this.fb = fb;
