...
var CheckoutReviewComponent = /** @class */ (function () {
    ...
    CheckoutReviewComponent.prototype.getAddressContent = function () {
        var _this = this;
        this.wpService.getPost(3812).subscribe(function (postData) {
            _this.addressData = postData;
        });
    };
...
var ConfirmationComponent = /** @class */ (function () {
    ...
    ConfirmationComponent.prototype.ngOnInit = function () {
        ...
        this.orderService.getOrderResult().subscribe(function (result) {
            ...
            console.log(_this.orderItemsForDisplay);
