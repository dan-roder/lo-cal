...
function contact_submission() {
	...
	$labels = array(
		'name'                  => _x( 'Contact Submissions', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Contact Submission', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Contact Submissions', 'text_domain' ),
		'name_admin_bar'        => __( 'Contact Submission', 'text_domain' ),
		'archives'              => __( 'Contact Submission Archives', 'text_domain' ),
		'attributes'            => __( 'Contact Submission Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'All Contact Submissions', 'text_domain' ),
		'add_new_item'          => __( 'Add New Submission', 'text_domain' ),
		'add_new'               => __( 'Add New', 'text_domain' ),
		'new_item'              => __( 'New Item', 'text_domain' ),
		'edit_item'             => __( 'Edit Item', 'text_domain' ),
		'update_item'           => __( 'Update Item', 'text_domain' ),
		'view_item'             => __( 'View Contact Submission', 'text_domain' ),
		'view_items'            => __( 'View Contact Submissions', 'text_domain' ),
		'search_items'          => __( 'Search Contact Submissions', 'text_domain' ),
		'not_found'             => __( 'Not found', 'text_domain' ),
		'not_found_in_trash'    => __( 'Not found in Trash', 'text_domain' ),
		'featured_image'        => __( 'Featured Image', 'text_domain' ),
		'set_featured_image'    => __( 'Set featured image', 'text_domain' ),
...
add_action( 'init', 'contact_submission', 0 );
